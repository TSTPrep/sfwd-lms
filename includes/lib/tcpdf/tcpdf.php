		...
		switch($tag['value']) {
			...
			case 'img': {
				...
				if ($imgsrc[0] === '@') {
					...
					/**
					 * 2020-08-27: The following block of code incorrectly decodes theimage 'src'.
					 * The problem this creates is related to query string params which might be themselves a URL that need to be properly encoded/decoded. See LEARNDASH-5234 for more details.
					 */
					if ( ( defined( 'LEARNDASH_TCPDF_LEGACY_LD322' ) ) && ( true === LEARNDASH_TCPDF_LEGACY_LD322 ) ) {
