    ...
    $.wpProQuizFront = function (element, options) {
        ...
        plugin.methode = {
            ...
            makeAjaxCall: function (essayText, $question) {
                ...
                let data2 = {
                    'action': 'feedback_type_correct_sent',
                        ...
                        success: function (response) {
                            ...
                            if (response?.[0].object === 'chat.completion') {
                                $question
                                    ...
                                    .append(`<div class="openai-feedback">${newText}</div>`);
                            }
                ...
                let promise2 = new Promise((resolve, reject) => {
                    $.ajax({
                        type: 'POST',
                        url: WpProQuizGlobal.ajaxurl, // The WordPress AJAX URL
                        data: data2,
                        success: function (response) {
                            console.log('stopAjaxCall - correct');

                            const $container = $question
                                .find('.wpProQuiz_question_text')
                                .append(`<div class="openai-correct_sent"></div>`)
                                .find('.openai-correct_sent');
                            renderResponse($container, response.data);
            ...
            checkQuestion(list, endCheck) {
                ...
                plugin.methode.ajax(
                    ...
                    function (json) {
                        ...
                        console.log('ajax-methode-plugin')
